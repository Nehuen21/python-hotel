"""
Script para buscar el paquete python_hotel desde el directorio raiz del proyecto.
    ...
    try:
        for item in os.listdir(directorio):
            ...
            if os.path.isfile(ruta_completa) and item.endswith('.py'):
                ...
                if item not in ['integrador.py', 'integradorFinal.py', 'integrador_proyecto.py']:
...
def main():
    ...
    # --- CAMBIO UNICO: Nombre del paquete a buscar ---
    nombre_paquete_principal = "python_hotel"
    ...
    if len(sys.argv) > 1:
        ...
        if comando == "integrar":
            ...
            print("Uso: python integrador_proyecto.py [COMANDO] [OPCIONES]")
            print("")
            print("Comandos disponibles:")
            print(f"  (sin argumentos)       Busca el paquete {nombre_paquete_principal}")
            ...
            print("")
            print("Ejemplos:")
            print("  python integrador_proyecto.py")
            print("  python integrador_proyecto.py integrar")
            print(f"  python integrador_proyecto.py integrar {nombre_paquete_principal}")
            return 0

        else:
            print(f"[!] Comando desconocido: {comando}")
            print("    Use 'python integrador_proyecto.py help' para ver los comandos disponibles")
            return 1

    # Modo por defecto: buscar paquete
    print(f"[INFO] Buscando desde: {directorio_raiz}")
    print(f"[INFO] Buscando paquete: {nombre_paquete_principal}")
    print("")

    # Buscar el paquete
    paquetes = buscar_paquete(directorio_raiz, nombre_paquete_principal)
    ...
    if paquetes:
        ...
        print(f"[!] No se encontro el paquete {nombre_paquete_principal}")
        return 1
